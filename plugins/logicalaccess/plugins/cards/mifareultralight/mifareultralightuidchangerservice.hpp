 ...
 */
class LIBLOGICALACCESS_API MifareUltralightUIDChangerCardService : public UIDChangerCardService
{
  public:
    /**
    ...
    std::string getCSType() override { return CHANGE_SERVICE_MIFAREULTRALIGHT_UID; }
