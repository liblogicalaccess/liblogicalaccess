...
ISO7816ResultChecker::ISO7816ResultChecker()
{
	...
	AddCheck(0x65, 0x00,
             "Process aborted, Execution error, state of NVM has changed, No information "
             "given",
             CardException::EXECUTION_ERROR);
	...
	AddCheck(0x68, 0x83, "Last command of the chain expected");
    AddCheck(0x68, 0x84, "Command chaining not supported");
    ...
    AddCheck(0x69, 0x99, "SW_APPLET_SELECT_FAILED"); // JCRE
    ...
    AddCheck(0x6A, 0x84, "Not enough memory space in the file");
    AddCheck(0x6A, 0x85, "Nc inconsistent with TLV structure");
