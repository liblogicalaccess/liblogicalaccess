/**
 * \file stidstrreaderserialportdatatransport.hpp
 * \author Adrien J. <adrien.jund@islog.com>
 * \brief STidSTR DataTransport.
 */

#ifndef STIDSTRREADERSERIALPORTDATATRANSPORT_HPP
#define STIDSTRREADERSERIALPORTDATATRANSPORT_HPP
...
{
class LLA_READERS_STIDSTR_API STidSTRSerialPortDataTransport
    : public SerialPortDataTransport
{
  public:
    explicit STidSTRSerialPortDataTransport(const std::string &portname = "")
...
#endif /* STIDSTRREADERSERIALPORTDATATRANSPORT_HPP */