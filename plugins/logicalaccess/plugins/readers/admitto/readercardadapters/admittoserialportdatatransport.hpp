/**
 * \file admittoserialportdatatransport.hpp
 * \author Adrien J. <adrien.jund@islog.com>
 * \brief Admitto DataTransport.
 */

#ifndef ADMITTOSERIALPORTDATATRANSPORT_HPP
#define ADMITTOSERIALPORTDATATRANSPORT_HPP
...
{
class LLA_READERS_ADMITTO_API AdmittoSerialPortDataTransport
    : public SerialPortDataTransport
{
  public:
    explicit AdmittoSerialPortDataTransport(const std::string &portname = "")
...
#endif /* ADMITTOSERIALPORTDATATRANSPORT_HPP */