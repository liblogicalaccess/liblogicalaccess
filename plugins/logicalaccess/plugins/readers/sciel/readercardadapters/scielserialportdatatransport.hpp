/**
 * \file scielserialportdatatransport.hpp
 * \author Adrien J. <adrien.jund@islog.com>
 * \brief Sciel DataTransport.
 */

#ifndef SCIELSERIALPORTDATATRANSPORT_HPP
#define SCIELSERIALPORTDATATRANSPORT_HPP
...
{
class LLA_READERS_SCIEL_API ScielSerialPortDataTransport : public SerialPortDataTransport
{
  public:
    explicit ScielSerialPortDataTransport(const std::string &portname = "")
...
#endif /* SCIELSERIALPORTDATATRANSPORT_HPP */