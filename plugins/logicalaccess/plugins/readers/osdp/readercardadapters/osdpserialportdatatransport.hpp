/**
 * \file osdpserialportdatatransport.hpp
 * \author Adrien J. <adrien.jund@islog.com>
 * \brief OSDP DataTransport.
 */

#ifndef OSDPSERIALPORTDATATRANSPORT_HPP
#define OSDPSERIALPORTDATATRANSPORT_HPP
...
{
class LLA_READERS_OSDP_API OSDPSerialPortDataTransport : public SerialPortDataTransport
{
  public:
    explicit OSDPSerialPortDataTransport(const std::string &portname = "")
...
#endif /* OSDPSERIALPORTDATATRANSPORT_HPP */