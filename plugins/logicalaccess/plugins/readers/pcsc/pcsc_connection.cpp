...
std::string logicalaccess::PCSCConnection::strerror(unsigned int error_flag)
{
    ...
    if (error_flag != SCARD_S_SUCCESS)
    {
        ...
        case SCARD_E_INVALID_HANDLE: msg += "The supplied handle was invalid."; break;
        ...
        case SCARD_E_PCI_TOO_SMALL: msg += "The PCI Receive buffer was too small."; break;
        ...
        case SCARD_E_UNEXPECTED: msg += "An unexpected card error has occurred."; break;
        ...
        case SCARD_E_NO_ACCESS: msg += "Access is denied to this file."; break;
        ...
        case SCARD_E_INVALID_CHV: msg += "The supplied PIN is incorrect."; break;
        ...
        case SCARD_E_NO_PIN_CACHE: msg += "The smart card PIN cannot be cached."; break;
