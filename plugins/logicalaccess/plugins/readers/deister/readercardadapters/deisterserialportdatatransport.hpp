/**
 * \file deisterserialportdatatransport.hpp
 * \author Adrien J. <adrien.jund@islog.com>
 * \brief Deister DataTransport.
 */

#ifndef DEISTERSERIALPORTDATATRANSPORT_HPP
#define DEISTERSERIALPORTDATATRANSPORT_HPP
...
{
class LLA_READERS_DEISTER_API DeisterSerialPortDataTransport
    : public SerialPortDataTransport
{
  public:
    explicit DeisterSerialPortDataTransport(const std::string &portname = "")
...
#endif /* DEISTERSERIALPORTDATATRANSPORT_HPP */