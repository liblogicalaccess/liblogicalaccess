 ...
 *
 * The Context class is used by OpenSSLSymmetricCipher to perform block cipherement. It
 * cannot be publicly instanciated.
 */
...
inline EVP_CIPHER_CTX *OpenSSLSymmetricCipherContext::ctx() const
{
    return d_information->ctx;
}
inline OpenSSLSymmetricCipher::Method OpenSSLSymmetricCipherContext::method() const
{
    return d_information->method;
}
inline ByteVector &OpenSSLSymmetricCipherContext::data() const
{
    return d_information->data;
}
}
}
