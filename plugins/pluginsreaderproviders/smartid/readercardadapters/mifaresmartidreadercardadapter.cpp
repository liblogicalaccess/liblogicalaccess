...
{
	ByteVector MifareSmartIDReaderCardAdapter::sendCommand(unsigned char cmd, const ByteVector& command, long int timeout)
    {
	    ...
	    ByteVector result = SmartIDReaderCardAdapter::sendCommand(0x80, wrappedCommand, timeout);
