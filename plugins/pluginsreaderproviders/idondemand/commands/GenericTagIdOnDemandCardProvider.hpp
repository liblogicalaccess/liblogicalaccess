/**
 * \file generictagidondemandcardprovider.hpp
 * \author Maxime C. <maxime-dev@islog.com>
 * \brief Generic tag IdOnDemand card provider.
 */

#ifndef LOGICALACCESS_GENERICTAGIDONDEMANDCARDPROVIDER_HPP
#define LOGICALACCESS_GENERICTAGIDONDEMANDCARDPROVIDER_HPP
