...
namespace logicalaccess
{
    ...
    {
    public:
	    explicit PromagDataTransport(const std::string& portname = "") : SerialPortDataTransport(portname) {}
         ...
         */
	    std::string getTransportType() const override { return "PromagSerialPort"; }
         ...
         */
	    std::string getDefaultXmlNodeName() const override { return "PromagDataTransport"; }
    };
}
