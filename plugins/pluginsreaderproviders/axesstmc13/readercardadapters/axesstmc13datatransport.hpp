...
namespace logicalaccess
{
    ...
    {
    public:
	    explicit AxessTMC13DataTransport(const std::string& portname = "") : SerialPortDataTransport(portname) {}
         ...
         */
	    std::string getTransportType() const override { return "AxessTMC13SerialPort"; }
         ...
         */
	    std::string getDefaultXmlNodeName() const override { return "AxessTMC13DataTransport"; }
    };
}
