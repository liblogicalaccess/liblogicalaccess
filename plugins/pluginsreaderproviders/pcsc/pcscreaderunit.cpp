...
namespace logicalaccess
{
    ...
    void PCSCReaderUnit::beginTransaction()
    {
        ...
        if (SCARD_S_SUCCESS != r) {
            THROW_EXCEPTION_WITH_LOG(CardException, "Failed SCardBeginTransaction error: " + std::to_string(r));
        }
    }
    ...
    void PCSCReaderUnit::endTransaction(DWORD dwDisposition)
    {
        ...
        if (SCARD_S_SUCCESS != r) {
            THROW_EXCEPTION_WITH_LOG(CardException, "Failed SCardEndTransaction error: " + std::to_string(r));
        }
    }
