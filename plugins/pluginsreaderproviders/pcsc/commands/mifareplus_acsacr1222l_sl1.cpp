...
bool MifarePlusACSACR1222L_SL1Commands::AESAuthenticate(std::shared_ptr<AES128Key> key,
                                                        uint16_t keyslot)
{
...
ByteVector MifarePlusACSACR1222L_SL1Commands::GenericSessionGuard::Adapter::adaptCommand(
    const ByteVector &in)
{
    ByteVector full_cmd;
...
ByteVector MifarePlusACSACR1222L_SL1Commands::GenericSessionGuard::Adapter::adaptAnswer(
