...
namespace logicalaccess
{
    ...
    {
    public:
	    explicit GigaTMSDataTransport(const std::string& portname = "") : SerialPortDataTransport(portname) {}
         ...
         */
	    std::string getTransportType() const override { return "GigaTMSSerialPort"; }
         ...
         */
	    std::string getDefaultXmlNodeName() const override { return "GigaTMSDataTransport"; }
    };
}
