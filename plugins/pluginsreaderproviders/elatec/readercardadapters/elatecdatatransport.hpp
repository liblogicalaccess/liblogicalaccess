...
namespace logicalaccess
{
    ...
    {
    public:
	    explicit ElatecDataTransport(const std::string& portname = "") : SerialPortDataTransport(portname) {}
         ...
         */
	    std::string getTransportType() const override { return "ElatecSerialPort"; }
         ...
         */
	    std::string getDefaultXmlNodeName() const override { return "ElatecDataTransport"; }
    };
}
