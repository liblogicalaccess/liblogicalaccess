/**
 * \file ElatecReaderUnit.h
 * \author Maxime C. <maxime-dev@islog.com>
 * \brief Elatec Reader unit.
 */

#ifndef LOGICALACCESS_ELATECREADERUNIT_H
#define LOGICALACCESS_ELATECREADERUNIT_H
...
namespace logicalaccess
{
	...
	class LIBLOGICALACCESS_API ElatecReaderUnit : public ReaderUnit
	{
		public:			
			 ...
			 * \brief Constructor.
			 */
			ElatecReaderUnit(boost::shared_ptr<SerialPortXml> port);
