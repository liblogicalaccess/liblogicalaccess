...
namespace logicalaccess
{
    ...
    {
    public:
	    explicit DeisterDataTransport(const std::string& portname = "") : SerialPortDataTransport(portname) {}
         ...
         */
	    std::string getTransportType() const override { return "DeisterSerialPort"; }
         ...
         */
	    std::string getDefaultXmlNodeName() const override { return "DeisterDataTransport"; }
    };
}
