...
namespace logicalaccess
{
    ...
    void ISO7816ISO7816Commands::writeBinary(const ByteVector& data, size_t offset, short efid)
    {
        unsigned char p1, p2;
    ...
    void ISO7816ISO7816Commands::updateBinary(const ByteVector& data, size_t offset, short efid)
    {
        unsigned char p1, p2;
    ...
    {
	    ByteVector result = getISO7816ReaderCardAdapter()->sendAPDUCommand(0x00, 0xCA, (0xff & (dataObject >> 8)), (0xff & dataObject));
        return ByteVector(result.begin(), result.end() - 2);
    }
    ...
    {
        getISO7816ReaderCardAdapter()->sendAPDUCommand(0x00, 0xA4, p1, p2, static_cast<unsigned char>(datalen), ByteVector(data, data + datalen));
    }
}