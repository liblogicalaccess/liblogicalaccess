...
namespace logicalaccess
{
    ...
    {
    public:
	    explicit STidSTRDataTransport(const std::string& portname = "") : SerialPortDataTransport(portname) {}
         ...
         */
	    std::string getTransportType() const override { return "STidSTRSerialPort"; }
         ...
         */
	    std::string getDefaultXmlNodeName() const override { return "STidSTRDataTransport"; }
    };
}
