...
namespace logicalaccess
{
	namespace openssl
	{
		...
		public:
			 ...
			 */
			static std::vector<unsigned char> cmac(const std::vector<unsigned char>& key, boost::shared_ptr<openssl::OpenSSLSymmetricCipher> cipherMAC, unsigned int block_size, const std::vector<unsigned char>& data, std::vector<unsigned char> lastIV);
