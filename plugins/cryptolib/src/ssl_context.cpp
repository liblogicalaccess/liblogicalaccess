...
namespace logicalaccess
{
    namespace openssl
    {
        ...
        void SSLContext::loadVerificationCertificate(const X509Certificate& verification_certificate) const
        {
        ...
        void SSLContext::loadVerificationCertificateFile(const std::string& verification_certificate_file) const
        {
        ...
        void SSLContext::loadVerificationCertificatePath(const std::string& verification_certificate_path) const
        {
