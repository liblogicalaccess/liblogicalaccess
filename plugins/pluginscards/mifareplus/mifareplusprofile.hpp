/**
 * \file MifarePlusProfile.hpp
 * \author Xavier S. <xavier.schmerber@gmail.com>
 * \brief MifarePlus card profiles.
 */

#ifndef LOGICALACCESS_MIFAREPLUS_HPP
#define LOGICALACCESS_MIFAREPLUS_HPP
...
namespace logicalaccess
{
    ...
    public:
         ...
         */
        virtual std::shared_ptr<MifarePlusKey> getKey(int index, MifarePlusKeyType keytype) const = 0;

        /**
         * \brief Create a new AES key.
         */
        virtual inline std::shared_ptr<MifarePlusKey> createAESKey() { return std::shared_ptr<MifarePlusKey>(new MifarePlusKey(MIFARE_PLUS_AES_KEY_SIZE)); };

        /**
         * \brief Create a new crypto1 key.
         */
        virtual inline std::shared_ptr<MifarePlusKey> createCrypto1Key() { return std::shared_ptr<MifarePlusKey>(new MifarePlusKey(MIFARE_PLUS_CRYPTO1_KEY_SIZE)); };
         ...
         */
        virtual void setKey(int index, MifarePlusKeyType keytype, std::shared_ptr<MifarePlusKey> key) = 0;
