...
extern "C"
{
    ...
    LIBLOGICALACCESS_API void getMifarePlus4KChip(std::shared_ptr<logicalaccess::Chip>* chip)
    {
        if (chip != NULL)
        {
            *chip = std::shared_ptr<logicalaccess::MifarePlus4KChip>(new logicalaccess::MifarePlus4KChip());
        }
    }
