...
{
void SagemKeyDiversification::initDiversification(ByteVector identifier, int /*AID*/,
...
ByteVector SagemKeyDiversification::getDiversifiedKey(std::shared_ptr<Key> key,
                                                      ByteVector diversify)
{
