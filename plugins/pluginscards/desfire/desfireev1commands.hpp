...
namespace logicalaccess
{
	...
	class LIBLOGICALACCESS_API DESFireEV1Commands : public virtual DESFireCommands
	{
		public:		
			 ...
			 * \param maxNbKeys Maximum number of keys
			 */
			virtual void createApplication(unsigned int aid, DESFireKeySettings settings, unsigned char maxNbKeys, DESFireKeyType cryptoMethod, FidSupport fidSupported = FIDS_NO_ISO_FID, unsigned short isoFID = 0x00, const char* isoDFName = NULL) = 0;			
