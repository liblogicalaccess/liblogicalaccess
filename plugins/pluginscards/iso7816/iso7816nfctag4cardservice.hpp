...
namespace logicalaccess
{
    ...
    public:
         ...
         * \param chip The chip.
         */
	    explicit ISO7816NFCTag4CardService(std::shared_ptr<Chip> chip) : NFCTagCardService(chip) {}
        ...
        virtual std::shared_ptr<NdefMessage> readNDEFFile(unsigned short isoFIDApplication = 0xe105, unsigned short isoFIDNDEFFile = 0xe104);
