/**
 * \file mifarecardprovider.hpp
 * \author Maxime C. <maxime-dev@islog.com>
 * \brief Mifare card interface.
 */

#ifndef LOGICALACCESS_MIFARECARDPROVIDER_HPP
#define LOGICALACCESS_MIFARECARDPROVIDER_HPP
...
{	
	 ...
	 */
	class LIBLOGICALACCESS_API MifareCardProvider : public CardProvider
	{
		public:			
			 ...
			 */
			boost::shared_ptr<MifareChip> getMifareChip();

			boost::shared_ptr<MifareCommands> getMifareCommands() const { return boost::dynamic_pointer_cast<MifareCommands>(getCommands()); };
...
#endif /* LOGICALACCESS_MIFARECARDPROVIDER_HPP */
