/**
 * \file desfirecardprovider.hpp
 * \author Maxime C. <maxime-dev@islog.com>
 * \brief DESFire card provider.
 */

#ifndef LOGICALACCESS_DESFIRECARDPROVIDER_HPP
#define LOGICALACCESS_DESFIRECARDPROVIDER_HPP
...
#endif /* LOGICALACCESS_DESFIRECARDPROVIDER_HPP */
