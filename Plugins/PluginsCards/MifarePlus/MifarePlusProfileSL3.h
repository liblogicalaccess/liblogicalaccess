/**
 * \file MifarePlusProfileSL3.h
 * \author Xavier S. <xavier.schmerber@gmail.com>
 * \brief MifarePlus card profiles.
 */

#ifndef LOGICALACCESS_MIFAREPLUSSL3_H
#define LOGICALACCESS_MIFAREPLUSSL3_H
...
{	
	 ...
	 */
	class LIBLOGICALACCESS_API MifarePlusProfileSL3 : public MifarePlusProfile
	{
		public:
			 ...
			 * \brief Constructor.
			 */
			MifarePlusProfileSL3();

			/**
			 * \brief Destructor.
			 */
			virtual ~MifarePlusProfileSL3();		
		...
		protected:	
			...
			boost::shared_ptr<MifarePlusKey> d_originalityKey;
			boost::shared_ptr<MifarePlusKey> d_masterCardKey;
			boost::shared_ptr<MifarePlusKey> d_configurationKey;
	};	
}
