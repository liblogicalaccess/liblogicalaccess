/**
 * \file MifarePlusProfileSL1.h
 * \author Xavier S. <xavier.schmerber@gmail.com>
 * \brief MifarePlus card profiles.
 */

#ifndef LOGICALACCESS_MIFAREPLUSSL1_H
#define LOGICALACCESS_MIFAREPLUSSL1_H
...
{	
	 ...
	 */
	class LIBLOGICALACCESS_API MifarePlusProfileSL1 : public MifarePlusProfile
	{
		public:
			 ...
			 * \brief Constructor.
			 */
			MifarePlusProfileSL1();

			/**
			 * \brief Destructor.
			 */
			virtual ~MifarePlusProfileSL1();		
