/**
 * \file GenericTagAccessControlCardService.h
 * \author Maxime CHAMLEY <maxime.chamley@islog.eu>
 * \brief Generic Tag Access Control Card service.
 */

#ifndef LOGICALACCESS_GENERICTAGACCESSCONTROLCARDSERVICE_H
#define LOGICALACCESS_GENERICTAGACCESSCONTROLCARDSERVICE_H
