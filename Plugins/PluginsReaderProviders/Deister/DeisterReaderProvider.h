/**
 * \file DeisterReaderProvider.h
 * \author Maxime CHAMLEY <maxime.chamley@islog.eu>
 * \brief Deister card reader provider. 
 */

#ifndef LOGICALACCESS_READERDEISTER_PROVIDER_H
#define LOGICALACCESS_READERDEISTER_PROVIDER_H
...
#endif /* LOGICALACCESS_READERDEISTER_PROVIDER_H */
