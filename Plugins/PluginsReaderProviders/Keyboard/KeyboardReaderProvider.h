/**
 * \file KeyboardReaderProvider.h
 * \author Maxime C. <maxime-dev@islog.com>
 * \brief Keyboard card reader provider. 
 */

#ifndef LOGICALACCESS_READERKEYBOARD_PROVIDER_H
#define LOGICALACCESS_READERKEYBOARD_PROVIDER_H
...
#endif /* LOGICALACCESS_READERKEYBOARD_PROVIDER_H */
