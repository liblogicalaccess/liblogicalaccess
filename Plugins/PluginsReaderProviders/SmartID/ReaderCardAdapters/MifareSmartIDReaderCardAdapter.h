/**
 * \file MifareSmartIDReaderCardAdapter.h
 * \author Maxime C. <maxime-dev@islog.com>
 * \brief Mifare SmartID reader/card adapter. 
 */

#ifndef LOGICALACCESS_MIFARESMARTIDREADERCARDADAPTER_H
#define LOGICALACCESS_MIFARESMARTIDREADERCARDADAPTER_H
...
#endif /* LOGICALACCESS_MIFARESMARTIDREADERCARDADAPTER_H */
