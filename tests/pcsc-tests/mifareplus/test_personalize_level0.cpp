...
void test_write_perso_reject_invalid_access_bits(
    std::shared_ptr<MifarePlusSL0Commands> mpu)
{
...
int main(int ac, char **av)
{
    ...
    try
    {
        mpu->writePerso(MF_L2_SWITCH_KEY, {{0}});
    } // mifare plus S doesn't have this
    catch (...)
    {
