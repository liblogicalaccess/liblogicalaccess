...
TEST(test_epass_utils, test_secure_messaging_3)
{
    ...
    ASSERT_EQ(
        BufferHelper::fromHexString("04303130365F36063034303030305C0261759000"),
        decrypted_response);
}

TEST(test_epass_utils, test_parse_ef_com)
{
    auto raw = BufferHelper::fromHexString(
        "60165F0104303130375F36063034303030305C046175636E");
...
{
    auto binary = ByteVector{
        0x61, 0x5b, 0x5f, 0x1f, 0x58, 0x50, 0x3c, 0x55, 0x54, 0x4f, 0x41, 0x4e,
