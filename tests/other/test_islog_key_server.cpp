...
void test_des_encrypt_decrypt()
{
    ...
    assert(v == decrypted);
    auto expected = ByteVector{0xf9, 0x0a, 0xba, 0x97, 0x69, 0x00c, 0xaf, 0x10};
    ...
    assert(v == decrypted);
    expected =
        ByteVector{0xcf, 0x95, 0xbe, 0x9c, 0x37, 0x89, 0xb5, 0xe3, 0x35, 0xf6, 0xd4, 0x58,
    ...
    assert(v == decrypted);
    expected = {0x04, 0x5d, 0xca, 0xc6, 0xb3, 0xda, 0x0a, 0xa2, 0x04, 0x5d, 0xca, 0xc6,
                0xb3, 0xda, 0x0a, 0xa2, 0x04, 0x5d, 0xca, 0xc6, 0xb3, 0xda, 0x0a, 0xa2,
                0x04, 0x5d, 0xca, 0xc6, 0xb3, 0xda, 0x0a, 0xa2, 0x04, 0x5d, 0xca, 0xc6,
                0xb3, 0xda, 0x0a, 0xa2, 0x04, 0x5d, 0xca, 0xc6, 0xb3, 0xda, 0x0a, 0xa2,
                0x04, 0x5d, 0xca, 0xc6, 0xb3, 0xda, 0x0a, 0xa2, 0x04, 0x5d, 0xca, 0xc6,
                0xb3, 0xda, 0x0a, 0xa2, 0x04, 0x5d, 0xca, 0xc6, 0xb3, 0xda, 0x0a, 0xa2,
                0x04, 0x5d, 0xca, 0xc6, 0xb3, 0xda, 0x0a, 0xa2};
    assert(encrypted == expected);
}
