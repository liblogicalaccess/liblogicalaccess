/**
 * \file DataClockFormat.h
 * \author Maxime C. <maxime-dev@islog.com>
 * \brief DataClockFormat.
 */

#ifndef LOGICALACCESS_DATACLOCKFORMAT_H
#define LOGICALACCESS_DATACLOCKFORMAT_H	
...
#endif /* LOGICALACCESS_DATACLOCKFORMAT_H */
