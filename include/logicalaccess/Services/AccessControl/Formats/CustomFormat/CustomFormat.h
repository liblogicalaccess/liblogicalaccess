...
#ifndef LOGICALACCESS_CUSTOMFORMAT_H
#define LOGICALACCESS_CUSTOMFORMAT_H	
...
namespace logicalaccess
{
	...
	class LIBLOGICALACCESS_API CustomFormat : public Format
	{
		public:
			 ...
			 */
			boost::shared_ptr<DataField> getFieldForPosition(unsigned int position);
...
#endif /* LOGICALACCESS_CUSTOMFORMAT_H */
