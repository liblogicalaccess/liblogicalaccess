/**
 * \file CardsFormatComposite.h
 * \author Maxime C. <maxime-dev@islog.com>
 * \brief Cards format composite.
 */

#ifndef LOGICALACCESS_CARDSFORMATCOMPOSITE_H
#define LOGICALACCESS_CARDSFORMATCOMPOSITE_H
...
#endif /* LOGICALACCESS_CARDSFORMATCOMPOSITE_H */
