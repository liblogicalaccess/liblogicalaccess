/**
 * \file NoDataRepresentation.h
 * \author Maxime C. <maxime-dev@islog.com>
 * \brief NoDataRepresentation.
 */

#ifndef LOGICALACCESS_NODATAREPRESENTATION_H
#define LOGICALACCESS_NODATAREPRESENTATION_H	
...
#endif /* LOGICALACCESS_NODATAREPRESENTATION_H */
