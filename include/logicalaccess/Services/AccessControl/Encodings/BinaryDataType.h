/**
 * \file BinaryDataType.h
 * \author Arnaud H <arnaud-dev@islog.com>, Maxime C. <maxime-dev@islog.com>
 * \brief BinaryDataType.
 */

#ifndef LOGICALACCESS_BINARYDATATYPE_H
#define LOGICALACCESS_BINARYDATATYPE_H	
...
#endif /* LOGICALACCESS_BINARYDATATYPE_H */
