...
class LLA_CORE_API FASCN200BitFormat : public StaticFormat
{
  public:
    ...
    static const unsigned char
        FASCN_SS_WITH_PARITY; /**< \brief The Start Sentinel value with parity. */
    static const unsigned char
        FASCN_FS_WITH_PARITY; /**< \brief The Field Separator value with parity. */
    static const unsigned char
        FASCN_ES_WITH_PARITY; /**< \brief The End Sentinel value with parity. */
