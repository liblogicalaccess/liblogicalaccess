...
namespace logicalaccess
{
    ...
    public:
         ...
         */
        unsigned long long revertNumericData(const BitsetStream& data, unsigned int fieldlen) const;
         ...
         */
        void revertBinaryData(const BitsetStream& data, unsigned int fieldlen, BitsetStream& revertedData) const;
